...
%\begin{problem*}\import{../Ch-biochemistry/problems/}{StudyCheck1}\vspace{1cm}  
%\begin{solution}[1.0in]\end{solution}
%\end{problem*}
%\begin{problem*}\import{../Ch-biochemistry/problems/}{StudyCheck2}\vspace{1cm}  
%\begin{solution}[1.0in]\end{solution}
%\end{problem*}
%\begin{problem*}\import{../Ch-biochemistry/problems/}{StudyCheck3}\vspace{1cm}  
%\begin{solution}[1.0in]\end{solution}
%\end{problem*}
%\begin{problem*}\import{../Ch-biochemistry/problems/}{StudyCheck4}\vspace{1cm}  
%\begin{solution}[1.0in]\end{solution}
%\end{problem*}
%\begin{problem*}\import{../Ch-biochemistry/problems/}{StudyCheck5}\vspace{1cm}  
%\begin{solution}[1.0in]\end{solution}
%\end{problem*}
%\begin{problem*}\import{../Ch-biochemistry/problems/}{StudyCheck6}\vspace{1cm}  
%\begin{solution}[1.0in]\end{solution}
%\end{problem*}
%\begin{problem*}\import{../Ch-biochemistry/problems/}{StudyCheck7}\vspace{1cm}  
%\begin{solution}[1.0in]\end{solution}
%\end{problem*}
%\begin{problem*}\import{../Ch-biochemistry/problems/}{StudyCheck8}\vspace{1cm}  
%\begin{solution}[1.0in]\end{solution}
%\end{problem*}



\begin{problem*}\import{../Ch-biochemistry/problems/}{StudyCheck9}\vspace{1cm}  
\begin{solution}[1.0in]\end{solution}
\end{problem*}


\begin{problem*}\import{../Ch-biochemistry/problems/}{StudyCheck10}\vspace{1cm}  
\begin{solution}[1.0in]\end{solution}
\end{problem*}

\begin{problem*}\import{../Ch-biochemistry/problems/}{StudyCheck11}\vspace{1cm}  
\begin{solution}[1.0in]\end{solution}
\end{problem*}

%\begin{problem*}\import{../Ch-biochemistry/problems/}{StudyCheck12}\vspace{1cm}  
%\begin{solution}[1.0in]\end{solution}
%\end{problem*}
...
\end{problem*}
 ...
 \begin{problem*}\import{../Ch-electrolytes/problems/}{StudyCheck9}\vspace{1cm}  
\begin{solution}[1.0in]\end{solution}
\end{problem*}
