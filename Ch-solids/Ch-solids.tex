...
\import{../Ch-solids/files/}{SectionGoal-Heating-curves}
\end{enumerate}
\end{mytcbox}
\vspace{1cm}
...
\item[\docfilehook{Phase transition terminology}{}]\import{files/}{Subsection-Phase-diagrams-Phase-transition-terminology}
...
\item[\docfilehook{Change of state}{ }] \import{files/}{Subsection-Phase-diagrams-Change-of-state}

\item[\docfilehook{Temperature curves}{ }] \import{files/}{Subsection-Phase-diagrams-Temperature-curves}
 


 
\import{files/}{Figure-Heating-curve}
