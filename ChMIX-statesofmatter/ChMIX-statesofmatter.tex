...
\begin{marginfigure}\includegraphics{../Ch-solids/figure1} \end{marginfigure}\import{../Ch-solids/files/}{ChapterIntro}
...
\begin{enumerate}[label=\protect\circled{\color{white}\arabic*}]
\import{../\chapterlabel/files/}{SectionGoal-Using-other-equalities}
\end{enumerate}
...
\hspace{0cm}\import{../\chapterlabel/files/}{Figure-Matter}		

\end{description}


 \section{\faTint Solution composition}
\sloppy\begin{description}
...
\import{../Ch-electrolytes/problems/}{SampleProblem7}
 ...
 \renewcommand\chapterlabel{Ch-mole}
    \hspace{0cm}\import{../\chapterlabel/files/}{Figure-The-mole}
\section{\faEnvira The mole}
...
\import{../Ch-mole/files/}{SubSection-Converting-moles-into-grams-and-into-atoms-From-moles-to-grams}
 \import{../Ch-mole/problems/}{SampleProblem3}
  \renewcommand\chapterlabel{Ch-nuclear} \import{../\chapterlabel/files/}{SideFigure-Geiger}
